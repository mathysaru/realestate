...
public final class GoogleMap
{
  ...
  public final Circle addCircle(CircleOptions paramCircleOptions)
  {
    try
    {
      paramCircleOptions = new Circle(this.pf.addCircle(paramCircleOptions));
  ...
  public final GroundOverlay addGroundOverlay(GroundOverlayOptions paramGroundOverlayOptions)
  {
    try
    {
      paramGroundOverlayOptions = this.pf.addGroundOverlay(paramGroundOverlayOptions);
  ...
  public final Marker addMarker(MarkerOptions paramMarkerOptions)
  {
    try
    {
      paramMarkerOptions = this.pf.addMarker(paramMarkerOptions);
  ...
  public final Polygon addPolygon(PolygonOptions paramPolygonOptions)
  {
    try
    {
      paramPolygonOptions = new Polygon(this.pf.addPolygon(paramPolygonOptions));
  ...
  public final Polyline addPolyline(PolylineOptions paramPolylineOptions)
  {
    try
    {
      paramPolylineOptions = new Polyline(this.pf.addPolyline(paramPolylineOptions));
  ...
  public final TileOverlay addTileOverlay(TileOverlayOptions paramTileOverlayOptions)
  {
    try
    {
      paramTileOverlayOptions = this.pf.addTileOverlay(paramTileOverlayOptions);
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, int paramInt, CancelableCallback paramCancelableCallback)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 99	com/google/android/gms/maps/GoogleMap:pf	Lcom/google/android/gms/maps/internal/IGoogleMapDelegate;
    //   4: astore 4
    //   6: aload_1
    //   7: invokevirtual 175	com/google/android/gms/maps/CameraUpdate:cs	()Lcom/google/android/gms/dynamic/b;
    //   10: astore 5
    //   12: aload_3
    //   13: ifnonnull +17 -> 30
    //   16: aconst_null
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, CancelableCallback paramCancelableCallback)
  {
    ...
    //   4: astore_3
    //   5: aload_1
    //   6: invokevirtual 175	com/google/android/gms/maps/CameraUpdate:cs	()Lcom/google/android/gms/dynamic/b;
    //   9: astore 4
    //   11: aload_2
    //   12: ifnonnull +15 -> 27
    //   15: aconst_null
  ...
  public final boolean setIndoorEnabled(boolean paramBoolean)
  {
    try
    {
      paramBoolean = this.pf.setIndoorEnabled(paramBoolean);
      return paramBoolean;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setInfoWindowAdapter(final InfoWindowAdapter paramInfoWindowAdapter)
  {
    ...
    this.pf.setInfoWindowAdapter(new d.a()
    {
      ...
      {
        return c.g(paramInfoWindowAdapter.getInfoWindow(new Marker(paramAnonymousd)));
      }
      
      public b g(d paramAnonymousd)
      {
        return c.g(paramInfoWindowAdapter.getInfoContents(new Marker(paramAnonymousd)));
      }
    });
  }
      ...
      public void activate(final g paramAnonymousg)
      {
        paramLocationSource.activate(new LocationSource.OnLocationChangedListener()
        {
          public void onLocationChanged(Location paramAnonymous2Location)
          {
            try
            {
              paramAnonymousg.g(c.g(paramAnonymous2Location));
              return;
            }
  ...
  {
    if (paramBitmap != null) {}
    for (paramBitmap = c.g(paramBitmap);; paramBitmap = null)
    {
...
/* Location:              C:\Users\shivane\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\maps\GoogleMap.class
