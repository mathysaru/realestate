...
public final class BitmapDescriptorFactory
{
  ...
  public static BitmapDescriptor defaultMarker()
  {
    try
    {
      BitmapDescriptor localBitmapDescriptor = new BitmapDescriptor(cL().cQ());
  ...
  public static BitmapDescriptor defaultMarker(float paramFloat)
  {
    try
    {
      BitmapDescriptor localBitmapDescriptor = new BitmapDescriptor(cL().c(paramFloat));
      return localBitmapDescriptor;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public static BitmapDescriptor fromAsset(String paramString)
  {
    try
    {
      paramString = new BitmapDescriptor(cL().S(paramString));
      return paramString;
    }
  ...
  public static BitmapDescriptor fromBitmap(Bitmap paramBitmap)
  {
    try
    {
      paramBitmap = new BitmapDescriptor(cL().a(paramBitmap));
      return paramBitmap;
    }
  ...
  public static BitmapDescriptor fromFile(String paramString)
  {
    try
    {
      paramString = new BitmapDescriptor(cL().T(paramString));
      return paramString;
    }
    catch (RemoteException paramString)
    {
  ...
  public static BitmapDescriptor fromPath(String paramString)
  {
    try
    {
      paramString = new BitmapDescriptor(cL().U(paramString));
      return paramString;
    }
    catch (RemoteException paramString)
    {
  ...
  public static BitmapDescriptor fromResource(int paramInt)
  {
    try
    {
      BitmapDescriptor localBitmapDescriptor = new BitmapDescriptor(cL().ad(paramInt));
      return localBitmapDescriptor;
    }
    catch (RemoteException localRemoteException)
    {
...
/* Location:              C:\Users\shivane\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\maps\model\BitmapDescriptorFactory.class
