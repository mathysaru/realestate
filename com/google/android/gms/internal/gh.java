    ...
    implements gh
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        {
          a(paramParcel2, (Bundle)localObject, gi.a.at(paramParcel1.readStrongBinder()));
          return true;
          paramParcel2 = null;
          break;
        }
      ...
      case 3: 
        ...
        {
          a((String)localObject, str, paramParcel2, gi.a.at(paramParcel1.readStrongBinder()));
          return true;
        }
      case 4: 
        label146:
      ...
      for (paramParcel2 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; paramParcel2 = null)
      {
        a(paramParcel2, gi.a.at(paramParcel1.readStrongBinder()));
        return true;
      }
    }
      ...
      implements gh
    {
        ...
        throws RemoteException
      {
        ...
        //   50: aload_0
        //   51: getfield 18	com/google/android/gms/internal/gh$a$a:dG	Landroid/os/IBinder;
        //   54: iconst_5
        //   55: aload 4
        //   57: aconst_null
        //   58: iconst_1
          ...
          try
          {
            ...
            if (paramFullWalletRequest != null)
            {
              ...
              if (paramBundle != null)
              {
                ...
                if (paramgi != null) {
                  paramFullWalletRequest = paramgi.asBinder();
                }
          ...
          try
          {
            ...
            if (paramMaskedWalletRequest != null)
            {
              ...
              if (paramBundle != null)
              {
                ...
                if (paramgi != null) {
                  paramMaskedWalletRequest = paramgi.asBinder();
                }
        ...
        throws RemoteException
      {
        ...
        //   66: aload_0
        //   67: getfield 18	com/google/android/gms/internal/gh$a$a:dG	Landroid/os/IBinder;
        //   70: iconst_3
        //   71: aload 6
        //   73: aconst_null
        //   74: iconst_1
...
/* Location:              C:\Users\shivane\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\internal\gh.class
