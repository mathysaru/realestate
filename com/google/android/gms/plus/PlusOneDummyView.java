  ...
  extends FrameLayout
{
  ...
  public PlusOneDummyView(Context paramContext, int paramInt)
  {
    ...
    paramContext.setBackgroundDrawable(cU().getDrawable(paramInt));
    Point localPoint = ae(paramInt);
    addView(paramContext, new FrameLayout.LayoutParams(localPoint.x, localPoint.y, 17));
  }
  
  private Point ae(int paramInt)
  {
    int j = 24;
    int i = 20;
...
/* Location:              C:\Users\shivane\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\plus\PlusOneDummyView.class
