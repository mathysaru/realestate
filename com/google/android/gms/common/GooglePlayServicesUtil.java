...
public final class GooglePlayServicesUtil
{
  ...
  public static Dialog a(int paramInt1, Activity paramActivity, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener, int paramInt3)
  {
    ...
    paramOnCancelListener = new dc(paramActivity, a(paramActivity, paramInt1, paramInt3), paramInt2);
  ...
  public static int isGooglePlayServicesAvailable(Context paramContext)
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      try
      {
        ...
        paramContext = a(paramContext, iQ);
  ...
  private static boolean o(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramContext = a(paramContext.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), iW);
        if (paramContext != null) {
          return true;
        }
      }
...
/* Location:              C:\Users\shivane\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\common\GooglePlayServicesUtil.class
